...
※ [2023年03月に公開](https://docs.snowflake.com/en/release-notes/2023-03)された「Individual Task Observability（個別タスクの可観測性）」のこと。
   Snowsight のタスク表示画面が強化され、グラフビューで個々のタスクの実行時間やスキップされたなどのステータスを確認でs着るようになりました。
...
-- 待ってるのはちょっとだるいので、image/week42/ にあるスクショを見ましょうね
...
　　※ https://www.ozl.jp/unit/integer/calc_indeq.html
    （★）式から、5x - 1, 6y とも 14 で割り切れなければならない。そのような最小の組は (x, y) = (17, 14). よって (x, y, z) = (17, 14, 6)

よって 84分後に dad が怒るって、タスクを実行しなくてもわかります
*/
